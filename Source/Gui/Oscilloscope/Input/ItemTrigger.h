 ...
 public:
  ...
  virtual void OnPaint() {
    ...
    switch (Settings.Trig.Type) {
      ...
      case CSettings::Trigger::_LevelLow:
        pSym2 = CShapes::trig_level_l;
        break;
      case CSettings::Trigger::_LevelHigh:
        pSym2 = CShapes::trig_level_g;
        break;
      case CSettings::Trigger::_LowerDTLow:
        pSym2 = CShapes::trig_pulse_ll;
        break;
      case CSettings::Trigger::_GreaterDTLow:
        pSym2 = CShapes::trig_pulse_gl;
        break;
      case CSettings::Trigger::_LowerDTHigh:
        pSym2 = CShapes::trig_pulse_lh;
        break;
      case CSettings::Trigger::_GreaterDTHigh:
        pSym2 = CShapes::trig_pulse_gh;
        break;
    }

    if (pSym1) BIOS::LCD::Draw(x, y, RGB565(000000), RGBTRANS, pSym1);
    ...
    if (HasFocus()) {
      ...
      BIOS::LCD::Print(x, y, clr, RGBTRANS,
                       CSettings::Trigger::ppszTextSync[Settings.Trig.Sync]);
    }
    ...
    if (!BIOS::ADC::Enabled()) {
      ...
      switch (Settings.Trig.State) {
        case CSettings::Trigger::_Run:
          x += BIOS::LCD::Draw(x, y, RGB565(00b000), RGBTRANS,
                               CShapes::trig_run);
          break;
        case CSettings::Trigger::_Stop:
          x += BIOS::LCD::Draw(x, y, RGB565(ff0000), RGBTRANS,
                               CShapes::trig_stop);
          break;
