 ...
 public:
  void Create(CSettings::AnalogChannel *pInfo, CWnd *pParent) {
    ...
    CListBox::Create(pInfo->pszFullName, WsVisible | WsModal,
                     CRect(120, 30, 319, 201), pInfo->u16Color, pParent);

    m_proEnabled.Create(
        (const char **)CSettings::AnalogChannel::ppszTextEnabled,
        (NATIVEENUM *)&pInfo->Enabled, CSettings::AnalogChannel::_EnabledMax);
    m_proCoupling.Create(
        (const char **)CSettings::AnalogChannel::ppszTextCoupling,
    ...
    m_proResolution.Create(
        ...
        (NATIVEENUM *)&pInfo->Resolution,
        CSettings::AnalogChannel::_ResolutionMax);
    m_proProbe.Create((const char **)CSettings::AnalogChannel::ppszTextProbe,
                      (NATIVEENUM *)&pInfo->Probe,
                      CSettings::AnalogChannel::_ProbeMax);
    ...
    m_itmColour.Create("Colour", CWnd::WsVisible | CWnd::WsNoActivate,
                       &m_proColour, this);
