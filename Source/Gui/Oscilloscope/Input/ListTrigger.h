 ...
 public:
  void Create(CWnd *pParent) {
    ...
    m_proSync.Create((const char **)CSettings::Trigger::ppszTextSync,
                     (NATIVEENUM *)&Settings.Trig.Sync,
                     CSettings::Trigger::_SyncMax);
    m_proType.Create((const char **)CSettings::Trigger::ppszTextType,
                     (NATIVEENUM *)&Settings.Trig.Type,
                     CSettings::Trigger::_TypeMax);
    m_proSource.Create((const char **)CSettings::Trigger::ppszTextSource,
                       (NATIVEENUM *)&Settings.Trig.Source,
                       CSettings::Trigger::_SourceMax);
    ...
    m_itmTrigPosition.Create("Trig. pos", CWnd::WsVisible, &m_proTrigPosition,
                             this);
  }
};
