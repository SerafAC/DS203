...
/*virtual*/ void CWndMenuMath::Create(CWnd *pParent, ui16 dwFlags) {
  CWnd::Create("CWndMenuMath", dwFlags,
...
/*virtual*/ void CWndMenuMath::OnMessage(CWnd *pSender, CodeParam code,
                                         DataParam data) {
  ...
  if (code == ToWord('m', 'c') && bSenderOperator) {
    m_wndListOperator.Create((CSettings::MathOperator *)data, this);
