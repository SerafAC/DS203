...
/*virtual*/ void CWndSpecAnnotations::OnPaint() {
  ...
  if (!MainWnd.m_wndSpectrumMiniSG.IsVisible()) {
    ...
    BIOS::LCD::Bar(x, rcTarget.top, rcTarget.left - 1, rcTarget.top + 16,
                   RGB565(000000));
    x += BIOS::LCD::Print(x, rcTarget.top, RGB565(b0b0b0), RGB565(000000),
                          strMax);
    x += 4;
    x += BIOS::LCD::Print(x, rcTarget.top, RGB565(808080), RGB565(000000),
                          strUnits);
  }
  ...
  BIOS::LCD::Print(x - 5 * 8, rcTarget.bottom + 2, RGB565(808080),
                   RGB565(000000), "SPAN ");
  x += BIOS::LCD::Print(x, rcTarget.bottom + 2, RGB565(b0b0b0), RGB565(000000),
                        strFreq);
  ...
  x += BIOS::LCD::Print(x, rcTarget.bottom + 2, RGB565(808080), RGB565(000000),
                        strFreq);
  x += BIOS::LCD::Draw(x, rcTarget.bottom + 2, RGB565(808080), RGB565(000000),
                       CShapes::per_div);
}
