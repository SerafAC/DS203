...
/*virtual*/ void CWndMenuCalibration::OnMessage(CWnd *pSender, CodeParam code,
  ...
  if (pSender == &m_itmSave && code == ToWord('m', 'o')) {
    MainWnd.m_wndConfirm.Show(
        this, "Confirmation",
        "Do you really want to\nsave calibration settings?", RGB565(ffff00),
        "Cancel", "Save");
    return;
  }
  if (pSender == &m_itmLoad && code == ToWord('m', 'o')) {
    MainWnd.m_wndConfirm.Show(
        this, "Confirmation",
        "Do you really want to\nload calibration settings?", RGB565(ffff00),
        "Cancel", "Load");
    return;
  }
  ...
  if (pSender == &MainWnd.m_wndConfirm && code == ToWord('e', 'd') &&
    ...
    if (Settings.LoadCalibration())
      ...
      MainWnd.m_wndMessage.Show(this, "Error",
  ...
  if (data == (DataParam)&m_wndListAdc.m_proExecute &&
      code == ToWord('l', 'e')) {
