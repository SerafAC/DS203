 ...
 public:
  void Create(CWnd *pParent) {
    ...
    CListBox::Create("ADC Calibration", WsVisible | WsModal,
                     CRect(20, 30, 280, 201), RGB565(8080b0), pParent);

    m_itmStaticA.Create("Set the numbers to get",
                        CWnd::WsVisible | CWnd::WsNoActivate, this);
    m_itmStaticB.Create("following voltage on wave out",
                        CWnd::WsVisible | CWnd::WsNoActivate, this);
    ...
    CValueProvider *arrADigits[4] = {&m_proADigit1000, &m_proADigit100,
                                     &m_proADigit10, &m_proADigit1};
    ...
    CValueProvider *arrBDigits[4] = {&m_proBDigit1000, &m_proBDigit100,
                                     &m_proBDigit10, &m_proBDigit1};
