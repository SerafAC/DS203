...
public:
  static void MenuItemDisabled(const CRect &rcRect, ui16 clr) {
    BIOS::LCD::RoundRect(rcRect.left, rcRect.top, rcRect.left + 12,
                         rcRect.bottom, clr);
    BIOS::LCD::Bar(rcRect.left + 8, rcRect.top, rcRect.right, rcRect.bottom,
                   RGB565(b0b0b0));
  }

  static void MenuItemEnabled(const CRect &rcRect, ui16 clr) {
    BIOS::LCD::RoundRect(rcRect.left - 2, rcRect.top, rcRect.right,
                         rcRect.bottom, clr);
    BIOS::LCD::RoundRect(rcRect.left + 8 - 2, rcRect.top + 1, rcRect.right - 1,
                         rcRect.bottom - 1, RGB565(ffffff));
  }

  static void MenuItemClearDisabled(const CRect &rcRect) {
    BIOS::LCD::Bar(rcRect.left, rcRect.top, rcRect.left + MenuItemIndent + 4,
                   rcRect.bottom, RGB565(000000));
  }

  static void MenuItemClearEnabled(const CRect &rcRect) {
    BIOS::LCD::Bar(rcRect.left, rcRect.top, rcRect.left + MenuItemIndent + 4,
                   rcRect.bottom, RGB565(000000));
    BIOS::LCD::Bar(rcRect.right - 4, rcRect.top, rcRect.right, rcRect.bottom,
                   RGB565(000000));
  }

  static void MenuBlockDisabled(const CRect &rcRect, ui16 clr) {
    // shadow
    BIOS::LCD::RoundRect(rcRect.right - 4, rcRect.top + 4, rcRect.right + 4,
                         rcRect.bottom + 4, RGB565(000070));
    BIOS::LCD::RoundRect(rcRect.left + 4, rcRect.bottom - 4, rcRect.right + 4,
                         rcRect.bottom + 4, RGB565(000070));

    // inside
    BIOS::LCD::RoundRect(rcRect.left, rcRect.top, rcRect.left + 12,
                         rcRect.bottom, clr);
    BIOS::LCD::Bar(rcRect.left + 8, rcRect.top, rcRect.right - 4, rcRect.bottom,
                   RGB565(b0b0b0));
    BIOS::LCD::RoundRect(rcRect.right - 8, rcRect.top, rcRect.right,
                         rcRect.bottom, RGB565(b0b0b0));
  }
  ...
  static void MenuBlockEnabled(const CRect &rcRect, ui16 clr) {
    ...
    // inside
    BIOS::LCD::RoundRect(rcRect.left, rcRect.top, rcRect.right, rcRect.bottom,
                         clr);
  }
  ...
  static void GradientTop(const CRect &rcRect) {
    ...
    BIOS::LCD::Pattern(rcRect.left, rcRect.top, rcRect.right, rcRect.bottom,
                       pattern, 16);
  ...
  static void Shadow(const CRect &rcRect, ui32 clr) {
    BIOS::LCD::Shadow(rcRect.left, rcRect.top, rcRect.right, rcRect.bottom,
                      clr);
  }
};
...
public:
  ...
  static void MenuItemEnabled(const CRect &rcRect, ui16 clr) {
    BIOS::LCD::Bar(rcRect.left - 2, rcRect.top, rcRect.left + 8 - 1,
                   rcRect.bottom, clr);
    BIOS::LCD::Bar(rcRect.left + 8 - 2, rcRect.top, rcRect.right, rcRect.bottom,
                   RGB565(ffffff));
  }
  ...
  static void Window(const CRect &rcRect, ui16 clr) {
    ...
    BIOS::LCD::Bar(rcRect.left, rcRect.top + 16, rcRect.right, rcRect.bottom,
                   RGB565(b0b0b0));
  }
