...
public:
  ...
  void Update() {
    ...
    BIOS::LCD::Printf(20, 0x90, RGB565(ff0000), 0,
                      "No device attached          ");
  }
  ...
  void UpdateBmp085() {
    ...
    BIOS::LCD::Printf(20, 0xA0, RGB565(00ff00), 0, "RawP = %d RawT = %d  ", nP,
                      nT);
  ...
  void UpdateDs1820() {
    bool bInit = false, bConv = false, bCrc = false, bTemp = false,
         bRom = false;
    float fTemp = 0;
    ...
    BIOS::LCD::Printf(20, 0x90, RGB565(ffFF00), 0, "OneWire status = %s     ",
                      strStatus);
  ...
  virtual void OnTimer() {
    ...
    BIOS::LCD::Print(20, 0x20, RGB565(ffffff), RGB565(000000),
                     "--- GPIOA ----------------------");
    BIOS::LCD::Printf(20, 0x30, RGB565(ffffff), RGB565(000000),
