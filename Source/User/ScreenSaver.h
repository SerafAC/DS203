...
public:
  ...
  virtual void Create(CWnd *pParent, ui16 dwFlags) {
    CWnd::Create("CWndScreenSaver", dwFlags | CWnd::WsTick | CWnd::WsNoActivate,
                 CRect(0, 16, 400, 240), pParent);
  }

  virtual void OnPaint() {
    BIOS::LCD::Bar(m_rcClient, RGB565(FFFFFF));
    BIOS::LCD::Print(m_rcClient.left + 8, m_rcClient.bottom - 20,
                     RGB565(000000), RGBTRANS, "Hello world!");
  }
